...
class DS3XINCModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        'Icp_xc_ccsaic' , 'Icp_xc_ccsbic' , 'DS_xa' , 'DS_xb' , 'DS_xc_rsab' , 'DS_xc_sab' ,\
    ...
    def backward_G(self):
        ...
        self.loss_Icp_xc_ccsaic + self.loss_Icp_xc_ccsbic + self.loss_DS_xa + self.loss_DS_xb + self.loss_DS_xc_rsab + self.loss_DS_xc_sab +\
