...
class SDGCRL1Model(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        parser.set_defaults(no_dropout=True,norm='modulate', netG='ModulateGen',netD='MsImageDis',\
    ...
    def backward_D(self):
        ...
        self.loss_D_a2a, self.loss_gp_a2a = self.backward_D_basic(self.netD_A, self.real_A2, self.x_a2a, self.real_C_a2)
        self.loss_D_a2b, self.loss_gp_a2b = self.backward_D_basic(self.netD_A, self.real_A2, self.x_a2b, self.real_C_a2)
        self.loss_D = self.loss_D_A + self.loss_D_B + self.loss_D_a2a + self.loss_D_a2b
        self.loss_gp = self.loss_gp_A + self.loss_gp_B + self.loss_gp_a2a + self.loss_gp_a2b
