...
class DS3XINCL1Model(BaseModel):
    """
    ...
    def __init__(self, opt):
        ...
        'Icp_xc_ccsaic' , 'Icp_xc_ccsbic' , 'DS_xc_rsab',\
        ...
        self.path_length_penalty = networks.PathLengthPenalty(0.99).to(self.device)
    ...
    def backward_G(self):
        ...
        #
        self.loss_crossrecon_xacb = self.recon_criterion(self.xa_cbsaita, self.real_A) * self.opt.recon_x_cyc_w if self.opt.recon_x_cyc_w > 0 else None
        self.loss_crossrecon_xbca = self.recon_criterion(self.xb_casbitb, self.real_B) * self.opt.recon_x_cyc_w if self.opt.recon_x_cyc_w > 0 else None
        ...
        #self.loss_DS_xc_rsab = self.path_length_penalty(self.wppl, self.xc_ccrsacondic)
        self.loss_DS_xc_rsab = 0
        # GAN loss
        ...
        self.loss_Icp_xc_ccsaic + self.loss_Icp_xc_ccsbic + self.loss_DS_xc_rsab +\
