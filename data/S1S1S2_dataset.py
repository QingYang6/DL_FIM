...
class S1S1S2Dataset(BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        x_nor = normalization_S1S1S2(x,self.files[idx])
...
def normalization_S1S1S2(input_array,file):
    normalindex = [100,100,30,100,100,30,30000,30000,30000]
