...
class S1S1LIALCCSLRLDataset(BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        x3 = np.load(self.files[randidx[1]])
        ...
        x_nor2 = normalization_S1S1LCC(x2,self.files[randidx[0]])
        x_nor3 = normalization_S1S1LCC(x3,self.files[randidx[1]])
        x_norRL = np.dstack((x_nor2,x_nor3))
